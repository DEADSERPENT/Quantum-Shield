            ...
            <div className="space-y-8">
              ...
              <div className="glass-card p-6">
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <svg className="w-5 h-5 text-quantum-cyan group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  >
                    <svg className="w-5 h-5 text-quantum-violet group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 focus:border-quantum-cyan/50 focus:outline-none text-white placeholder-gray-600 transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 focus:border-quantum-cyan/50 focus:outline-none text-white placeholder-gray-600 transition-colors resize-none"
